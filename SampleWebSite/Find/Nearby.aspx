<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Nearby.aspx.cs" Inherits="Find_Nearby" Title="Untitled Page" %>
<%@ Register Assembly="Simplovation.Web.Maps.VE" Namespace="Simplovation.Web.Maps.VE" TagPrefix="Simplovation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_PageTitle" Runat="Server">Find - Find Nearby</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_PageDescription" Runat="Server">
This is a basic example of performing a Find "nearby" search, that will search for "What" you are looking for near where the map is currently zoomed in to.
</asp:Content>
    ...
    <tr>
        ...
        <td>
            ...
            <Simplovation:Map runat="server" ID="Map1" Width="600px" Height="450px" CssClass="map" OnFindLoaded="Map1_FindLoaded"
                Latitude="43.0488197966932" Longitude="-87.9620361328125" Zoom="10" />        
