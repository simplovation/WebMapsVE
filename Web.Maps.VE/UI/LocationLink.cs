...
{
    /// <summary>
    /// A HyperLink control with Location specific propertyies (Latitude, Longitude, ZoomLevel, Shape) that specify where the Target Map control is repositioned to when clicked.
    /// </summary>
    public class LocationLink : HyperLink
    {
        public LocationLink()
        {
        ...
        public new string NavigateUrl
        {
            ...
            set
            {
                throw new Exception("NavigateUrl property can not be set.");
            }
        }

        protected override void OnPreRender(EventArgs e)
        {
            base.NavigateUrl = "javascript:" + this.NavigateUrl;
            base.OnPreRender(e);
        }
    }
}
